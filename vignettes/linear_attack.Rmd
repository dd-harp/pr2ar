...
The three equations we now have are a single-jump, a peekahead, and
a master equation.
\begin{eqnarray}
I_j &= &A(1-I_0) + QI_0\\
I_p &=&A(1-QI_0) + QI_0 \\
...
$$
You can mitigate this error by rewriting using Strang splitting [@celledoni2001methods].
$$
